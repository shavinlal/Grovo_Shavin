...
class UserAttributeListWithReq():
    
    def createListAttributewithReq(self):
        ...
        if ele.text == AttributeName :
            ...
            print ""
            raise Exception
        print "user Attribute List Type with required option is Created"
    ...
    def createListAttributeWithRequiredField(self):
        try:
            
            ob =UserAttributeListWithReq()
            ob.createListAttributewithReq()
