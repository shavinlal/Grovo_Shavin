...
class UserAttributeTextWithReq ():
    
    def attributewithReq(self):
        ...
        if ele.text == AttributeName :
            ...
            print ""
            raise Exception
        print "user Attribute Text Type with required option is Created"
    ...
    def createTextAttributeWithReq(self):
        try:
            
            obj= UserAttributeTextWithReq()
            obj.attributewithReq()
