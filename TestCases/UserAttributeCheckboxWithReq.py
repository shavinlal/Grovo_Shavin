...
class UserAttributeCheckboxWithReq():
    
    def createCheckboxAttributewithRequest(self):
        ...
        if ele.text == AttributeName :
            ...
            print ""
            raise Exception
        print "user Attribute Check Type with required option is Created"
    ...
    def createCheckBoxAttributeWithReq(self):
        try:
            
            ob =UserAttributeCheckboxWithReq()
            ob.createCheckboxAttributewithRequest()
