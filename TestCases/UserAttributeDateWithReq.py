...
from pip._vendor.pkg_resources import EntryPoint


class UserAttributeDateWithReq():
    
    def createDateAttributewithRequest(self):
    ...
    def createDateAttributeWithReq(self):
        try:
        
            obj= UserAttributeDateWithReq()
            obj.createDateAttributewithRequest()
