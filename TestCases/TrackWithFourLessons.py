...
class TrackWithFourLessons:
    ...
    def createLessonTxtImgQue(self,lessonName,textCard,Imagefilepath1,questionCard, ans1, ans2):
        ...
        #Text Card
        objforThis=TrackWithFourLessons()
    ...
    def trackWithFourLesson(self):
        ...
        try:     
            ...
            tr1.createLessonVidDocQue(lessonName3, videoPath, documentPath, questionCard, ans1, ans2, timeToUploadVideo)
