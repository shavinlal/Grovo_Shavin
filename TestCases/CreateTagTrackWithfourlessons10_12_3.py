...
class CreateTagTrackWithfourlessons10_12_3():
    
    def createTrackWithfourlessons10_12_3Tag(self):
        print "Reading data from excel sheet"
        book=xlrd.open_workbook(os.path.join('TestData.xlsx'))
        first_sheet = book.sheet_by_name('CreateTag')
        print("Fetching the Attribute Name from Excel Sheet\n")
        # read a cell
        cell = first_sheet.cell(16,2)
        TagName = cell.value
        print TagName
        
        cell = first_sheet.cell(16,3)
        ...
        ele =driver.find_element_by_xpath("html/body/div/div/div[3]/div[2]/div/div/section[2]/div/ul/li['"+TagName+"']")
        print ele.text
        if ele.text == TagName :
    ...
    def createTagForTrackWithFourLessonsTenTwelveThree(self):
        try :
            obj2= CreateTagTrackWithfourlessons10_12_3()
       
            obj2.createTrackWithfourlessons10_12_3Tag() 
        finally:  
