...
class CreateTagTrackLessonOneTextImageVideoDocumentQuestion():
    
    def createTrackLessonOneTextImageVideoDocumentQuestionTag(self):
    ...
    def  createTagForTrackLessonOneTextImageVideoDocumentQuestion(self):
        try :
            obj2= CreateTagTrackLessonOneTextImageVideoDocumentQuestion()
            obj2.createTrackLessonOneTextImageVideoDocumentQuestionTag() 
        finally:
