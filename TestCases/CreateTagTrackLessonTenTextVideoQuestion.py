...
class CreateTagTrackLessonTenTextVideoQuestion():
    
    def createTrackLessonTenTextVideoQuestiontag(self):
        print "Reading data from excel sheet"
        book=xlrd.open_workbook(os.path.join('TestData.xlsx'))
        first_sheet = book.sheet_by_name('CreateTag')
        print("Fetching the Attribute Name from Excel Sheet\n")
        # read a cell
        cell = first_sheet.cell(10,2)
        TagName = cell.value
        print TagName
    ...
    def createTagForTrackLessonTenTextVideoQuestion(self):
     try :
        obj2= CreateTagTrackLessonTenTextVideoQuestion()
  
        obj2.createTrackLessonTenTextVideoQuestiontag() 
     finally:  
