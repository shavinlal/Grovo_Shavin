...
class CreateTagTracklessonFiveTextImageQuestion():
    
    def createTracklessonFiveTextImageQuestionTag(self):
    ...
    def createTagForTrackLessonFiveTextImageQuestion(self):
        try:
         obj2= CreateTagTracklessonFiveTextImageQuestion()
        
         obj2.createTracklessonFiveTextImageQuestionTag()  
        finally:
