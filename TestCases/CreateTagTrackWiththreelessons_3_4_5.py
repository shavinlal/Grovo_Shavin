...
class CreateTagTrackWiththreelessons_3_4_5():
    
    def createTrackWiththreelessons_3_4_5Tag(self):
    ...
    def createTagForTrackWithThreeLessonsThreeFourFive(self):
        try:
     
            obj2= CreateTagTrackWiththreelessons_3_4_5()
         
            obj2.createTrackWiththreelessons_3_4_5Tag() 
        finally:  
