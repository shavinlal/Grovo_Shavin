...
class CreateTagLessonLimitedmultiplecardlesson_1():
    
    def createLessonLimitedmultiplecardlesson_1tag(self):
        print "Reading data from excel sheet"
        book=xlrd.open_workbook(os.path.join('TestData.xlsx'))
        first_sheet = book.sheet_by_name('CreateTag')
        print("Fetching the Attribute Name from Excel Sheet\n")
        # read a cell
        cell = first_sheet.cell(32,2)
        TagName = cell.value
        print TagName
        
        cell = first_sheet.cell(32,3)
    ...
    def createTagForLessonLimitedMultipleCardLessonOne(self):
        try :
            obj2= CreateTagLessonLimitedmultiplecardlesson_1()
            obj2.createLessonLimitedmultiplecardlesson_1tag() 
        finally:  
