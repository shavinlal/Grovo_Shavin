...
class CreateTagTrackLessonQuestion():
    
    def createTrackLessonQuestionTag(self):
    ...
    def createTagForTrackLessonQuestion(self):
        try:
             obj2= CreateTagTrackLessonQuestion()
        
             obj2.createTrackLessonQuestionTag()   
        finally:
            print "clicking on Home"
            book=xlrd.open_workbook(os.path.join('TestData.xlsx'))
            first_sheet = book.sheet_by_name('Login_Credentials')
