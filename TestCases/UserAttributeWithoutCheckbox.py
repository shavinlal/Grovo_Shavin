...
class UserAttributeWithoutCheckbox():
    
    def createCheckboxAttributewithoutRequest(self):
        ...
        print "Selected Check box Type"
        driver.find_element_by_xpath("html/body/div/div/div[3]/div[2]/div/div[3]/div/div/div/div[5]/label").click()
        ...
        if ele.text == AttributeName :
            ...
            print ""
            raise Exception
        print "user Attribute Check Type without required option is Created"
    ...
    def createCheckBoxAttributeWithoutReq(self):
        try:
            ob =UserAttributeWithoutCheckbox()
            ob.createCheckboxAttributewithoutRequest()
