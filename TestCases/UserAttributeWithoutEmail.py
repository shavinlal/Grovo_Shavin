...
class UserAttributeWithoutEmail():
    ...
    def createDateAttributewithoutRequest(self):
        ...
        if ele.text == AttributeName :
            ...
            print ""
            raise Exception
        print "user Attribute Email Type without required option is Created"
    ...
    def createEmailAttributeWithoutReq(self):
        try:
            
            obj= UserAttributeWithoutEmail()
