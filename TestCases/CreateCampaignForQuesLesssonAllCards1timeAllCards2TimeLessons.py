...
class CreateCampaignForQuesLesssonAllCards1timeAllCards2TimeLessons:
    
    def createCampaignThreeLessons(self,campaignTitle,campDescription,actualSuccessMessage,lessonName1,lessonName2,lessonName3,minPassingScore,numberOfAttempts):
        elements=CampPage()
    ...
    def allCardsOneTime(self,lessonName,textCard,Imagefilepath1,videoPath, timeToUploadVideo,documentPath,questionCard, ans1, ans2):
        ...
        #Text Card
        objfore=CreateCampaignForQuesLesssonAllCards1timeAllCards2TimeLessons()
    ...
    def createCampaignWithThreeLessons(self):
        ...
        cell1 = first_sheet.cell(165,1)
        minPassingScore = cell1.value
        
        cell1 = first_sheet.cell(166,1)
        numberOfAttempts = cell1.value
        
        #Lesson Data
        cell1 = first_sheet.cell(168,1)
        lessonName1 = cell1.value
        
        cell1 = first_sheet.cell(169,1)
        ...
        cell1 = first_sheet.cell(173,1)
        videoPath = cell1.value
        
        cell1 = first_sheet.cell(174,1)
        timeToUploadVideo = cell1.value
        
        
        cell1 = first_sheet.cell(175,1)
        documentPath = cell1.value
        
        cell1 = first_sheet.cell(176,1)
        questionCard = cell1.value
        
        cell1 = first_sheet.cell(177,1)
        ans1 = cell1.value
        
        cell1 = first_sheet.cell(178,1)
        ans2 = cell1.value
        ...
        try:
            ...
            newobj=CreateCampaignForQuesLesssonAllCards1timeAllCards2TimeLessons()
            newobj.lessonWithQuestion(lessonName1, questionCard, ans1, ans2)
            newobj.allCardsOneTime(lessonName2, textCard, Imagefilepath1, videoPath, timeToUploadVideo, documentPath, questionCard, ans1, ans2)
            newobj.allCardsTwoTime(lessonName3, textCard, Imagefilepath1, videoPath, timeToUploadVideo, documentPath, questionCard, ans1, ans2)
            newobj.createCampaignThreeLessons(campaignTitle, campDescription, actualSuccessMessage, lessonName1, lessonName2, lessonName3, minPassingScore, numberOfAttempts)
