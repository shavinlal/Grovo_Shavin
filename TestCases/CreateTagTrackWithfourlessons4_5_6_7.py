...
class CreateTagTrackWithfourlessons4_5_6_7():
    
    def createTrackWithfourlessons4_5_6_7Tag(self):
    ...
    def createTagForTrackWithFourLessonsFourFiveSixSeven(self):
        try :
        
            obj2= CreateTagTrackWithfourlessons4_5_6_7()
           
            obj2.createTrackWithfourlessons4_5_6_7Tag() 
        finally:  
