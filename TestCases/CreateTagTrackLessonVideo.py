...
class CreateTagTrackLessonVideo():
    
    def createTrackLessonVideoTag(self):
    ...
    def createTagForTrackLessonVideo(self):
        try:
     
         obj2= CreateTagTrackLessonVideo()
         obj2.createTrackLessonVideoTag()   
        finally:
