...
class CreateMasterAdmin():
    def createMasterAdminuser(self):
        ...
        wait.until(EC.visibility_of_element_located((By.XPATH,"//div[@role='option' and .='Master Administrator']")))
        ele =driver.find_element_by_xpath("//div[@role='option' and .='Master Administrator']")
