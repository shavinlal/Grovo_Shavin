...
class CreateTagTrackWithTwolessons_1_2():
    
    def createTrackWithTwolessons_1_2Tag(self):
    ...
    def createTagForTrackWithTwoLessonsOneTwo(self):
        try:
    
            obj2= CreateTagTrackWithTwolessons_1_2()
         
            obj2.createTrackWithTwolessons_1_2Tag()   
        finally:
            print "clicking on Home"
            book=xlrd.open_workbook(os.path.join('TestData.xlsx'))
            first_sheet = book.sheet_by_name('Login_Credentials')
