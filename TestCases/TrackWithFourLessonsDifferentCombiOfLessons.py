...
class TrackWithFourLessonsDifferentCombiOfLessons:
    ...
    def createLessonTxtVidQue(self,lessonName,textCard,videoPath,questionCard,ans1,ans2,timeToUploadVideo):
        ...
        objto=TrackWithFourLessonsDifferentCombiOfLessons()
    ...
    def trackWithFourLessonsDiffCombi1(self):
        ...
        try:     
            ...
            tr1.lessonWithText(lessonName2, textCard)
            tr1.lessonWithImage(lessonName3, Imagefilepath1)
            tr1.lessonWithVideo(lessonName4, videoPath, timeToUploadVideo)
