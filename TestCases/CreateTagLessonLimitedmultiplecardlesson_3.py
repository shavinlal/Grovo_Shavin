...
class CreateTagLessonLimitedmultiplecardlesson_3():
    
    def createLessonLimitedmultiplecardlesson_3tag(self):
        print "Reading data from excel sheet"
        book=xlrd.open_workbook(os.path.join('TestData.xlsx'))
        first_sheet = book.sheet_by_name('CreateTag')
        print("Fetching the Attribute Name from Excel Sheet\n")
        # read a cell
        cell = first_sheet.cell(34,2)
        TagName = cell.value
        print TagName
        
        cell = first_sheet.cell(34,3)
    ...
    def createTagForLessonLimitedMultipleCardLessonThree(self):
        try :
            obj2= CreateTagLessonLimitedmultiplecardlesson_3()
      
            obj2.createLessonLimitedmultiplecardlesson_3tag() 
        finally:  
