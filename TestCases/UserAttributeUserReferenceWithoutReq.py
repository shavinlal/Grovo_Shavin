...
class UserAttributeUserReferenceWithoutReq():
    
    def createUserReferenceAttributewithoutReq(self):
        ...
        if ele.text == AttributeName :
            ...
            print ""
            raise Exception
        print "user Attribute User Reference Type without required option is Created"
