...
class CreateTagTrackWithTwolessons_2_3():
    
    def createTrackWithTwolessons_2_3Tag(self):
    ...
    def createTagForTrackWithTwoLessonsTwoThree(self):
        try:
            obj2= CreateTagTrackWithTwolessons_2_3()
            obj2.createTrackWithTwolessons_2_3Tag()  
        finally:
