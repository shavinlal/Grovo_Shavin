...
class UserAttributeUserReferenceWithReq():
    ...
    def createUserReferenceAttributewithReq(self):
        ...
        driver.find_element_by_xpath("html/body/div/div/div[3]/div[2]/div/div[3]/div/div/div/div[6]/label").click()
        ...
        if ele.text == AttributeName :
            ...
            print ""
            raise Exception
        print "user Attribute User Reference Type with required option is Created"
