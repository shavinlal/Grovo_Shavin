...
class CreateTagTrackWiththreelessons_5_6_7():
    
    def createTrackWiththreelessons_5_6_7Tag(self):
        print "Reading data from excel sheet"
        book=xlrd.open_workbook(os.path.join('TestData.xlsx'))
        first_sheet = book.sheet_by_name('CreateTag')
        print("Fetching the Attribute Name from Excel Sheet\n")
        # read a cell
        cell = first_sheet.cell(14,2)
        TagName = cell.value
        print TagName
    ...
    def CreateTagForTrackWithThreeLessonsFiveSixSeven(self):
    
        try:
            obj2= CreateTagTrackWiththreelessons_5_6_7()
             
            obj2.createTrackWiththreelessons_5_6_7Tag() 
        finally:
