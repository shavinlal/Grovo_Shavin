...
class CreateTagTrackLessonImage():
    
    def createTrackLessonImageTag(self):
    ...
    def createTagForTrackLessonImage(self):
    
     try:
         obj2= CreateTagTrackLessonImage()
        
         obj2.createTrackLessonImageTag()   
     finally:
