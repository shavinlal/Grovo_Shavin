...
class CreateTagTrackWithfourlessons78910():
    
    def createTrackWithfourlessons78910Tag(self):
    ...
    def createTagForTrackWithFourLessonSevenEightNineTen(self):
        try :
        
            obj2= CreateTagTrackWithfourlessons78910()
            
            obj2.createTrackWithfourlessons78910Tag() 
        finally:  
