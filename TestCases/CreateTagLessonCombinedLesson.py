...
class CreateTagLessonCombinedLesson():
    
    def createLessonCombinedLessontag(self):
    ...
    def createTagForCombinedLesson(self):
        try :
            obj2= CreateTagLessonCombinedLesson()
            obj2.createLessonCombinedLessontag() 
