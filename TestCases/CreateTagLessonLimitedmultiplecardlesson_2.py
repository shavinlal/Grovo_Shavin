...
class CreateTagLessonLimitedmultiplecardlesson_2():
    
    def createLessonLimitedmultiplecardlesson_2tag(self):
        print "Reading data from excel sheet"
        book=xlrd.open_workbook(os.path.join('TestData.xlsx'))
        first_sheet = book.sheet_by_name('CreateTag')
        print("Fetching the Attribute Name from Excel Sheet\n")
        # read a cell
        cell = first_sheet.cell(33,2)
        TagName = cell.value
        print TagName
        
        cell = first_sheet.cell(33,3)
    ...
    def  createTagForLessonLimitedMultipleLessonTwo(self):
        try :
            obj2= CreateTagLessonLimitedmultiplecardlesson_2()
            obj2.createLessonLimitedmultiplecardlesson_2tag() 
        finally:  
