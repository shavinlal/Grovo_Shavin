...
class CreateTagLessonMultiplecardlesson():
    
    def createLessonMultiplecardlessontag(self):
        print "Reading data from excel sheet"
        book=xlrd.open_workbook(os.path.join('TestData.xlsx'))
        first_sheet = book.sheet_by_name('CreateTag')
        print("Fetching the Attribute Name from Excel Sheet\n")
        # read a cell
        cell = first_sheet.cell(31,2)
        TagName = cell.value
        print TagName
        
        cell = first_sheet.cell(31,3)
    ...
    def createTagForLessonMultipleCardLesson(self):
        try :
        
            obj2= CreateTagLessonMultiplecardlesson()
            obj2.createLessonMultiplecardlessontag() 
