...
class CreateTagTrackWithonelesson_9():
    
    def createTrackWithonelesson_9Tag(self):
        print "Reading data from excel sheet"
        book=xlrd.open_workbook(os.path.join('TestData.xlsx'))
        first_sheet = book.sheet_by_name('CreateTag')
        print("Fetching the Attribute Name from Excel Sheet\n")
        # read a cell
        cell = first_sheet.cell(19,2)
        TagName = cell.value
        print TagName
        
        cell = first_sheet.cell(19,3)
    ...
    def createTagForTrackWithOneLessonNine(self):
        try :
           
            obj2= CreateTagTrackWithonelesson_9()
           
            obj2.createTrackWithonelesson_9Tag() 
        finally:  
