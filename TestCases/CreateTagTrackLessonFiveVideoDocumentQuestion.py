...
class CreateTagTrackLessonFiveVideoDocumentQuestion():
    
    def createTrackLessonFiveVideoDocumentQuestionTag(self):
    ...
    def createTagForTrackLessonFiveVideoDocumentQuestion(self):
        try:
            obj2= CreateTagTrackLessonFiveVideoDocumentQuestion()
            obj2.createTrackLessonFiveVideoDocumentQuestionTag()   
        finally:
