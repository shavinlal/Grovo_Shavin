...
class CreateCampaignForFourLessonsThree:
    ...
    def lessonWithQuestion(self,lessonName,questionCard,ans1,ans2,textCard):
        wait=WebDriverWait(driver, 60)
        wait.until(EC.visibility_of_element_located((By.XPATH,"//a[@href='/create/lessons']")))
        ...
        obj=CreateCampaignForFourLessonsThree()
        obj.textCard(textCard)
    ...
    #Taking methods of creating all cards
    ...
    def createCampaignWithFourLessonsThree(self):
        ...
        try:
            ...
            newobj.lessonWithDocument(lessonName1, documentPath, timeToUploaddocument)
            newobj.lessonWithQuestion(lessonName2, questionCard, ans1, ans2, textCard)
            newobj.allCardsOneTime(lessonName3, textCard, Imagefilepath1, videoPath, timeToUploadVideo, documentPath, questionCard, ans1, ans2)
            newobj.allCardstwoTime(lessonName4, textCard, Imagefilepath1, videoPath, timeToUploadVideo, documentPath, questionCard, ans1, ans2)
