...
class CampaignTrackAllCardsOnetimeLesson:
    ...
    def CampaignForTrackWithAllCardsOneTime(self):
        ...
        cell1 = first_sheet.cell(82,4)
        campaignTitle = cell1.value
        
        cell1 = first_sheet.cell(83,4)
        campDescription = cell1.value
        
        cell1 = first_sheet.cell(84,4)
        actualSuccessMessage = cell1.value
        
        
        #Track
        cell1 = first_sheet.cell(86,4)
        trackName = cell1.value
        
        cell2 = first_sheet.cell(87,4)
        Imagefilepath = cell2.value
        
        cell2 = first_sheet.cell(88,4)
        description = cell2.value
        
        cell2 = first_sheet.cell(89,4)
        tagName = cell2.value
        
        cell2 = first_sheet.cell(90,4)
        expectedSuccessText= cell2.value
        
        
        #Lesson
        cell2 = first_sheet.cell(92,4)
        ...
        try:
            #lesson Creation
            obj2=CampaignTrackAllCardsOnetimeLesson()
            obj2.allCardsOneTime(lessonName, textCard, Imagefilepath1, videoPath, timeToUploadVideo, documentPath, timetoUploadDoc, questionCard, ans1, ans2)
