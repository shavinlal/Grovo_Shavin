...
class CreateCampaignForAllCardsTwoTime:
    
    def createCampaignLessonAllCardsTwoTimes(self,campaignTitle,campDescription,lessonName,actualSuccessMessage):
    ...
    def allCardsTwoTime(self,lessonName,textCard,Imagefilepath1,videoPath, timeToUploadVideo,documentPath,questionCard, ans1, ans2):
        ...
        #Text Card
        objfore=CreateCampaignForAllCardsTwoTime()
