...
class TrackWithTxtVidQueLesson:
    ...
    def createLessonTxtVidQue(self,lessonName,textCard,videoPath,questionCard,ans1,ans2,timeToUploadVideo):
        ...
        objfor=TrackWithTxtVidQueLesson()
    ...
    def createTrackwithTxtVidQue(self,titleOfTrack,Imagefilepath,description,tagName,lessonname,expectedSuccessText):
    ...
    def lessonWithTextVideoQuestionCard(self):
        ...
        try:
            ...
            que.createLessonTxtVidQue(lessonname, textCard, videoPath, questionCard, ans1, ans2,timeToUploadVideo)
            que.createTrackwithTxtVidQue(titleOfTrack, Imagefilepath, description, tagName, lessonname, expectedSuccessText,)
        finally:
