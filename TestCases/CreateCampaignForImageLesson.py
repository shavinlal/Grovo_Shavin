...
class CreateCampaignForImageLesson:
    ...
    def lessonWithImage(self,lessonName,Imagefilepath1):
        ...
        #turning toggle on
        print "turning toggle on"
        driver.find_element_by_xpath("//div[@class='toggle-flex-wrapper']/div").click()
        #wait.until(EC.visibility_of_element_located((By.XPATH,"//span[@class='lesson-editor-status' and .='Saving...']")))
        wait.until(EC.visibility_of_element_located((By.XPATH,"//span[@class='lesson-editor-status' and .='Saved']")))
    ...
    def createCampaignImageLesson(self):
        ...
        #Campaign Data
        cell1 = first_sheet.cell(16,1)
        campaignTitle = cell1.value
        
        cell1 = first_sheet.cell(17,1)
