...
class TrackWithTextLesson:
    ...
    def trackLessonWithText(self,lessonName,textCard):
    ...
    def createTrackwithText(self,titleOfTrack,Imagefilepath,description,tagName,lessonname,expectedSuccessText):
    ...
    def trackWithLessonContainsTextCard(self):
        ...
        try:
            trtxt.trackLessonWithText(lessonName, textCard)
            trtxt.createTrackwithText(titleOfTrack, Imagefilepath, description, tagName,lessonName,expectedSuccessText)
