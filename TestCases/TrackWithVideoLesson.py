...
class TrackWithVideoLesson:
    ...
    def createTrackwithVideo(self,titleOfTrack,Imagefilepath,description,tagName,lessonname,expectedSuccessText):
    ...
    def lessonWithVideoCard(self):
        ...
        cell2 = first_sheet.cell(28,1)
        description = cell2.value
        
        cell2 = first_sheet.cell(29,1)
        tagName = cell2.value
        
        cell2 = first_sheet.cell(26,3)
        ...
        cell2 = first_sheet.cell(27,3)
        videoPath = cell2.value
        
        cell2 = first_sheet.cell(28,3)
        timeToUploadVideo = cell2.value
        
        try:
            vid=TrackWithVideoLesson()
            vid.lessonWithVideo(lessonname, videoPath, timeToUploadVideo)
            vid.createTrackwithVideo(titleOfTrack, Imagefilepath, description, tagName, lessonname, expectedSuccessText)
        finally:
